...
val sampleProducts = listOf(
    ...
    ProductRoom("room_3", "치킨 1마리", "", 5, 100, 28, "open", "B", "BBQ 황금올리브 치킨", 1),
    ProductRoom("room_4", "영화 관람권 2매", "", 5, 100, 55, "open", "B", "CGV 주말 영화 2매", 1),
    ProductRoom("room_5", "무선 이어폰", "", 7, 100, 19, "open", "A", "Galaxy Buds2 Pro", 1),
    ProductRoom("room_6", "로봇청소기 특가", "", 10, 100, 37, "open", "S", "Roborock S8 Pro Ultra", 1),
    ProductRoom("room_7", "에어팟 프로 2세대", "", 10, 100, 8, "open", "S", "Apple AirPods Pro 2", 1),
    ProductRoom("room_8", "프리미엄 공기청정기", "", 15, 100, 3, "open", "SS", "다이슨 공기청정기 한정 특가", 1),
)
